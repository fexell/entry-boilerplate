      ...
      <div className="w-full max-w-sm">
        ...
        {status === "success" && (
          <>
            ...
            <Link
              href="/auth/login"
              className="mt-6 w-full flex items-center justify-center gap-2 bg-amber-400 hover:bg-amber-300 text-neutral-950 font-medium text-sm rounded-lg py-2.5 transition-colors"
            >
              Gå till inloggning
            </Link>
          </>
